...
export const GUIDE_CONTENT = [
  { type: 'h1', text: 'ArthSutra — User Guide' },
  ...
  { type: 'ol', items: [
    ...
    'A "ArthSutra" icon appears on your Desktop and in the Start Menu. Use it any time.',
  ...
  { type: 'ul', items: [
    'GitHub issues: github.com/arthupadhyay/Arth-Sutra/issues',
